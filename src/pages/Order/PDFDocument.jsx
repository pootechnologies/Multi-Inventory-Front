                  ...
                  <View style={styles.tableCol1}>
                    <Text style={styles.tableCell}>
                      {index +
                        1 +
                        (chunkIndex > 0
                          ? itemsPerFirstPage + (chunkIndex - 1) * itemsPerPage
                          : 0)}
                    </Text>
                  </View>
                  <View style={styles.tableCol2}>
              ...
              <View style={styles.summarySection}>
                <View style={styles.summaryRow}>
                  ...
                  <Text style={styles.summaryValue}>
                    {formatCurrency(order.sub_total || 0)} ETB
                  </Text>
                </View>
                {order.vat >= 1 && (
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-[90%] lg:max-w-4xl">
        <button
          onClick={handleClose}
          className="absolute px-4 py-2 text-white bg-red-400 rounded-lg top-2 right-2 hover:bg-red-300"
        >
          <svg
            className="w-6 h-6"
            fill="none"
